          ...
          >
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-transparent group-hover:border-blue-500 group-hover:shadow-xl">
              <div className="text-center">
                ...
                {/* Button */}
                <button className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-colors group-hover:bg-blue-700">
              ...
              <div className="text-center">
                ...
                <ul className="text-left text-sm text-gray-500 space-y-2 mb-6">
                  <li className="flex items-center">
                    ...
                    Tạo và quản lý tour/dịch vụ
                  </li>
                  <li className="flex items-center">
                    <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    Dashboard quản lý đặt chỗ
                  </li>
                  <li className="flex items-center">
                    <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                ...
                {/* Button */}
                <button className="w-full bg-green-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-green-700 transition-colors group-hover:bg-green-700">
